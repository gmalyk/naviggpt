            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                        <h3 className="text-sm font-bold text-slate-700">Réponse standard AI</h3>
                        <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">À titre de comparaison</p>
                    </div>
                </div>
