        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                    <h2 className="text-lg font-bold text-slate-800">Configurations IA</h2>
                ...
                <div className="p-6 space-y-6">
                    <div className="space-y-3">
                        <label className="text-sm font-semibold text-slate-700">Moteur par défaut</label>
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Clé API OpenAI</label>
                            <input
                                type="password"
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-500 uppercase tracking-wider">Clé API Gemini</label>
                            <input
                                type="password"
                    ...
                    <div className="bg-amber-50 p-3 rounded-2xl flex gap-3 items-start border border-amber-100">
                        ...
                        <p className="text-[11px] text-amber-800 leading-tight">
                            Vos clés sont stockées localement dans votre navigateur et ne transitent par notre serveur que pour relayer vos requêtes. Nous ne les conservons pas.
                        </p>
                    </div>
                </div>
