        ...
        <section className="py-16 px-6 max-w-3xl mx-auto animate-in fade-in duration-500">
            <div className="rounded-3xl border border-slate-200 bg-white p-12 md:p-16 text-center shadow-sm hover:shadow-lg transition-shadow">
                <div className="flex flex-col items-center gap-8">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#7B8FA3]/10 rounded-full border border-[#7B8FA3]/20 brand-protect">
                        <Shield className="w-3.5 h-3.5 text-[#7B8FA3]" />
                        <span className="text-xs font-semibold text-[#7B8FA3] tracking-wide uppercase">
                    ...
                    <div className="w-20 h-20 rounded-full bg-slate-50 flex items-center justify-center ring-1 ring-slate-200">
                        <Users className="w-9 h-9 text-[#7B8FA3] brand-protect" />
                    </div>
                    ...
                    {loading ? (
                        <div className="w-8 h-8 border-2 border-[#7B8FA3]/30 border-t-[#7B8FA3] rounded-full animate-spin brand-protect" />
                    ) : status === 'accepted' ? (
                        ...
                        <div className="flex flex-col items-center gap-4 animate-in fade-in duration-300">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    disabled={submitting}
                                    className="inline-flex items-center gap-2 px-6 py-2.5 bg-[#7B8FA3] hover:bg-[#5A7085] text-white text-sm font-semibold rounded-full transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-60 disabled:cursor-not-allowed brand-protect"
                                >
                                    {submitting ? (
                        ...
                        <button
                            onClick={handleJoin}
                            className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#7B8FA3] hover:bg-[#5A7085] text-white font-semibold rounded-full transition-all duration-200 shadow-md hover:shadow-lg brand-protect"
                        >
