                ...
                <div className="flex-1">
                    <div className="rounded-3xl bg-slate-50 border border-slate-200 p-8">
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                { label: t('landing_feat_compass_cat1'), color: 'bg-[#B88644]' },
                                { label: t('landing_feat_compass_cat2'), color: 'bg-[#E6C15A]' },
                                { label: t('landing_feat_compass_cat3'), color: 'bg-[#D49078]' },
                                { label: t('landing_feat_compass_cat4'), color: 'bg-[#A39656]' },
                            ].map((cat, i) => (
