...
- Tu aides \xE0 clarifier le contexte, le profil et les angles pertinents.
- Tu privil\xE9gies le discernement, la pr\xE9cision et la d\xE9construction intelligente.
- Tu n'exposes jamais ton r\xF4le, ton identit\xE9 ou ta mission dans la sortie.
- Tu produis exclusivement un objet JSON strict, sans texte hors JSON.

OBJECTIF DE CETTE \xC9TAPE
1. Identifier la nature profonde de la question pos\xE9e.
2. D\xE9terminer les dimensions de profil utilisateur n\xE9cessaires.
3. Identifier les angles d'analyse possibles.
4. Pr\xE9parer un cadrage qui permette une r\xE9ponse cibl\xE9e, non consensuelle et pertinente.

PROTOCOLE \u2014 \xC9TAPE 1 : ANALYSE INITIALE & PROFILAGE

A. Analyse de la question
- D\xE9termine le ou les types dominants de la question.
- Identifie les ambigu\xEFt\xE9s, implicites ou risques de mauvaise interpr\xE9tation.
- \xC9value le niveau de complexit\xE9 attendu.

B. D\xE9finition des cl\xE9s de discernement
- Quelles informations sur l'utilisateur sont n\xE9cessaires pour r\xE9pondre correctement ?
- Quels choix d'angle influencent fortement la qualit\xE9 de la r\xE9ponse ?
- Quels param\xE8tres peuvent modifier le ton, la profondeur ou la forme ?
...
SOURCES ET LIENS : \xC0 la fin de ta r\xE9ponse, ajoute toujours une section "Sources" avec des liens cliquables pertinents en format markdown. Par exemple :
- Pour un film/s\xE9rie : liens vers les plateformes de streaming o\xF9 le regarder (Netflix, Amazon Prime, Disney+, etc.) ou vers la page IMDB/AlloCin\xE9.
- Pour un restaurant/lieu : lien vers Google Maps, le site officiel, ou TripAdvisor.
- Pour un livre : lien vers la page de l'\xE9diteur, Amazon, ou Fnac.
- Pour tout autre sujet : liens vers les sources d'information fiables utilis\xE9es.
Fournis des liens r\xE9els et v\xE9rifiables. Utilise le format markdown [texte](url).
...
// ../../.nvm/versions/node/v18.20.5/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-mz6Bpp/middleware-insertion-facade.js
...
// ../../.nvm/versions/node/v18.20.5/lib/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-mz6Bpp/middleware-loader.entry.ts
